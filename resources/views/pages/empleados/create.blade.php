                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="password" name="password" value="{{ old('password') }}" min="0"
                                                class="w-full rounded-lg shadow-sm input-focus py-3 px-4 bg-white dark:bg-gray-700 text-black dark:text-white @error('password') input-error @enderror"
                                                placeholder="***********">
                                            @error('password')
                                                <p class="error-message">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div>
                                            ...
                                            <input type="password" name="password_confirmation"
                                                class="w-full rounded-lg shadow-sm input-focus py-3 px-4 bg-white dark:bg-gray-700 text-black dark:text-white @error('password_confirmation') input-error @enderror"
                                                placeholder="***********">
                                    ...
                                    <div class="grid grid-cols-1 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="number" name="salario" value="{{ old('salario') }}" min="0"
                                                    step="0.01"
