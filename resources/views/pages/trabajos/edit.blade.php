...
<x-app-layout>
    ...
    <body class="bg-gradient-to-br from-indigo-50 to-purple-50 min-h-screen">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-12">
                    ...
                    <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                        Actualiza la información del trabajo y su equipo asignado
                    </p>
                </div>
                            ...
                            <form action="{{ route('trabajos.update', $trabajo->id) }}" method="POST">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">
                                                Estado del Reporte <span class="text-red-500">*</span>
                                            </label>
                                            <select name="estado_reporte"
                                                class="w-full rounded-lg shadow-sm input-focus py-3 px-4 bg-white dark:bg-gray-700 text-black dark:text-white @error('estado_reporte') input-error @enderror">
                                                @foreach($estados as $key => $estado)
                                                    <option value="{{ $key }}" @selected(old('estado_reporte', $trabajo->reporte->estado) == $key)>{{ $estado }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div>
                                            ...
                                            <select name="tipo_trabajo"
                                                ...
                                                @foreach($tipos_trabajo as $key => $tipo)
                                                    <option value="{{ $key }}" @selected(old('tipo_trabajo', $trabajo->tipo_trabajo) == $key)>{{ $tipo }}</option>
                                                @endforeach
                                            </select>
                                            @error('tipo_trabajo')
                                                <p class="error-message">{{ $message }}</p>
                                        ...
                                        <div>
                                            ...
                                            <select name="prioridad"
                                                ...
                                                @foreach($prioridades as $key => $prioridad)
                                                    <option value="{{ $key }}" @selected(old('prioridad', $trabajo->prioridad) == $key)>{{ $prioridad }}</option>
                                                @endforeach
                                            </select>
                                            @error('prioridad')
                                                <p class="error-message">{{ $message }}</p>
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <textarea name="descripcion" rows="4"
                                                ...
                                                placeholder="Describa el trabajo a realizar">{{ old('descripcion', $trabajo->descripcion) }}</textarea>
                                            @error('descripcion')
                                                <p class="error-message">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <textarea name="materiales" rows="3"
                                                ...
                                                placeholder="Liste los materiales necesarios">{{ old('materiales', $trabajo->materiales) }}</textarea>
                                            @error('materiales')
                                                <p class="error-message">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <textarea name="observaciones_materiales" rows="2"
                                                ...
                                                placeholder="Observaciones adicionales sobre los materiales">{{ old('observaciones_materiales', $trabajo->observaciones_materiales) }}</textarea>
        ...
        <!-- Script para manejar la selección de encargado -->
