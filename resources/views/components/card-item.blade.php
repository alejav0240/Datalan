<div class="card-hover bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
    <div class="flex flex-col md:flex-row">
        ...
        <!-- Icono de la tarjeta (Dependiendo del tipo) -->
        ...
        <div class="flex-1 p-6">
            <div class="flex justify-between items-start">
                ...
                <div class="text-right">
                    ...
                    <!-- Estado de actividad del usuario (solo para clientes y empleados) -->
                    @if($type !== 'permisos')
            ...
            <!-- Información adicional (teléfono, fechas, etc.) -->
