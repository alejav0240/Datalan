...
<div x-data="{ open: {{ $errors->any() ? 'true' : 'false' }} }">
    ...
    <x-button @click="open = true" class="bg-blue-100 dark:bg-blue-700 text-blue-500 dark:text-white hover:bg-blue-300 dark:hover:bg-blue-800 text-xs py-1 px-3 rounded-md shadow-sm transition">
    ...
    <div
        ...
        <div @click.away="open = false" class="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-2xl w-full p-6">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4 text-left">Editar Cliente</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="tipo_cliente" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">
                            ...
                            <option value="educacion" {{ old('tipo_cliente', $cliente->tipo_cliente) == 'educacion' ? 'selected' : '' }}>Educación</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre_cliente" value="{{ old('nombre_cliente', $cliente->nombre_cliente) }}" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="text" name="nit_ci" value="{{ old('nit_ci', $cliente->nit_ci) }}" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="text" name="rubro" value="{{ old('rubro', $cliente->rubro) }}" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="direccion_principal" rows="2" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">{{ old('direccion_principal', $cliente->direccion_principal) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="telefono" value="{{ old('telefono', $cliente->telefono) }}" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="text" name="celular" value="{{ old('celular', $cliente->celular) }}" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="email" name="email_acceso" value="{{ old('email_acceso', $cliente->email_acceso) }}" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="referencia" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">
                            ...
                            <option value="recomendacion" {{ old('referencia', $cliente->referencia) == 'recomendacion' ? 'selected' : '' }}>Recomendación</option>
                            <option value="publicidad" {{ old('referencia', $cliente->referencia) == 'publicidad' ? 'selected' : '' }}>Publicidad</option>
                            <option value="busqueda" {{ old('referencia', $cliente->referencia) == 'busqueda' ? 'selected' : '' }}>Búsqueda</option>
                            <option value="redes" {{ old('referencia', $cliente->referencia) == 'redes' ? 'selected' : '' }}>Redes Sociales</option>
                            <option value="otro" {{ old('referencia', $cliente->referencia) == 'otro' ? 'selected' : '' }}>Otro</option>
                        </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="observaciones" rows="2" class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-white">{{ old('observaciones', $cliente->observaciones) }}</textarea>
