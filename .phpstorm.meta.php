...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\HpAle\Herd\proyecto_dtln\public\storage' => 'string',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\Users\\HpAle\\Herd\\proyecto_dtln\\public\\storage',
...
'fortify.features','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.argon.memory',
'hashing.argon.threads','hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','jetstream.stack',
...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.verify_csrf_token','services.postmark.token','services.ses.key','services.ses.secret',
...
'view.compiled','concurrency.default','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs',
...
'two-factor.secret-key','two-factor.recovery-codes','profile.show','sanctum.csrf-cookie',
...
'inicio','clientes.store','json_data_feed','dashboard','analytics',
'fintech','customers','orders','invoices','shop',
'shop-2','product','cart','cart-2','cart-3',
'pay','campaigns','users-tabs','users-tiles','profile',
'feed','forum','forum-post','meetups','meetups-post',
'credit-cards','transactions','transaction-details','job-listing','job-post',
'company-profile','messages','tasks-kanban','tasks-list','inbox',
'calendar','account','notifications','apps','plans',
'billing','feedback','changelog','roadmap','faqs',
'empty-state','404','knowledge-base','onboarding-01','onboarding-02',
'onboarding-03','onboarding-04','button-page','form-page','dropdown-page',
'alert-page','modal-page','pagination-page','tabs-page','breadcrumb-page',
'badge-page','avatar-page','tooltip-page','accordion-page','icons-page','clientes.index','clientes.update','clientes.destroy','clientes.enable',
'empleados.index','empleados.create','empleados.store','empleados.show','empleados.edit',
'empleados.update','empleados.destroy',);
...
'components.action-section','components.app.header','components.app.sidebar','components.button','components.confirmation-modal',
'components.confirms-password','components.danger-button','components.dashboard.dashboard-card-01','components.dashboard.dashboard-card-02','components.dashboard.dashboard-card-03',
'components.dashboard.dashboard-card-04','components.dashboard.dashboard-card-05','components.dashboard.dashboard-card-06','components.dashboard.dashboard-card-07','components.dashboard.dashboard-card-08',
'components.dashboard.dashboard-card-09','components.dashboard.dashboard-card-10','components.dashboard.dashboard-card-11','components.dashboard.dashboard-card-12','components.dashboard.dashboard-card-13',
'components.date-select','components.datepicker','components.dialog-modal','components.dropdown','components.dropdown-filter',
'components.dropdown-help','components.dropdown-link','components.dropdown-notifications','components.dropdown-profile','components.form-section',
'components.info.info-contacto','components.info.info-empresa','components.info.info-footer','components.info.info-header','components.info.info-hero',
'components.info.info-productos','components.info.info-reportar-falla','components.info.info-servicios','components.input','components.input-error',
'components.label','components.modal','components.modal-search','components.modals.clientes-modal','components.nav-link',
'components.pagination-classic','components.pagination-numeric','components.responsive-nav-link','components.search-form','components.secondary-button',
'components.section-border','components.section-title','components.switchable-team','components.tables.clientes-table','components.tables.empleados-table',
'components.theme-toggle','components.validation-errors','inicio','layouts.app','layouts.authentication',
'layouts.guest','pages.clientes.clientes','pages.dashboard.dashboard','pages.empleados.empleados','pages.utility.404',
'pagination::simple-tailwind','pagination::tailwind','policy','profile.delete-user-form','profile.logout-other-browser-sessions-form',
'profile.show','profile.two-factor-authentication-form','profile.update-password-form','profile.update-profile-information-form','terms',
'vendor.pagination.simple-tailwind','vendor.pagination.tailwind','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
