...
'inicio','clientes.store','dashboard','analytics','fintech',
'clientes.index','clientes.update','clientes.destroy','clientes.enable','empleados.index',
'empleados.create','empleados.store','empleados.show','empleados.edit','empleados.update',
'empleados.destroy','direcciones.index','direcciones.store','direcciones.destroy','clientes.direcciones',);
...
'components.info.info-contacto','components.info.info-direcciones-contactos','components.info.info-empresa','components.info.info-footer','components.info.info-header',
'components.info.info-hero','components.info.info-productos','components.info.info-servicios','components.input','components.input-error',
'components.label','components.modal','components.modal-search','components.modals.clientes-direcciones-modal','components.modals.clientes-modal',
'components.modals.direcciones-modal','components.modals.empleados-modal','components.nav-link','components.pagination-classic','components.pagination-numeric',
'components.responsive-nav-link','components.search-form','components.secondary-button','components.section-border','components.section-title',
'components.switchable-team','components.tables.clientes-table','components.tables.empleados-table','components.theme-toggle','components.validation-errors',
'inicio','layouts.app','layouts.authentication','layouts.guest','pages.clientes.clientes',
'pages.dashboard.dashboard','pages.empleados.empleados','pages.utility.404','pagination::simple-tailwind','pagination::tailwind',
...
'profile.update-password-form','profile.update-profile-information-form','terms','vendor.pagination.simple-tailwind','vendor.pagination.tailwind',
...
'LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','BROADCAST_DRIVER',
